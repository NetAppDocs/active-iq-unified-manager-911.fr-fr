...
* MySQL Community Edition version 8.0.28 (à partir du référentiel MySQL).
* OpenJDK version 11.0.14 (à partir du référentiel Red Hat Extra Enterprise Linux Server)
* Python 3.6.x
...
+
link:task_manually_configure_epel_repository.html["Configuration manuelle du référentiel EPEL"]
...
+
link:task_manually_configure_mysql_repository.html["Configuration manuelle du référentiel MySQL"]
