...
+
Tous les clusters de votre environnement de stockage géré par Unified Manager s'affichent. La liste des clusters est triée par la colonne niveau de gravité de l'état de collecte. Vous pouvez cliquer sur un en-tête de colonne pour trier les clusters par différentes colonnes.
