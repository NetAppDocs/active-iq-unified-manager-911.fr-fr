...
* Si vous exécutez Graphite sur un serveur déployé à l'aide d'une adresse IPv6, la valeur de L'INTERFACE LINE_RECEIVER dans le fichier /opt/Graphite/conf/carbone.conf' doit être modifiée de « 0.0.0.0 » à « »: » » (`*LINE_RECEIVER_INTERFACE = ::*`)
